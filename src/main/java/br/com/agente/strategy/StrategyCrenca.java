...
public class StrategyCrenca extends Crenca implements java.io.Serializable {
		...
		try {
			...
			for (Object object : membros) {
				...
				if (parametrosMetodo == null || parametrosMetodo.isEmpty()) {
					System.out
							.println(" -- Método:" + metodo.getName() + " -- não tem parametros não é usado strategy");
					continue;
				}
				/**verificando se o método java tem corpo para analisar*/
